...
namespace Cilnn
{
    public abstract class NanomsgSocketBase : IDisposable
    {
        ...
        /// </summary>
        /// <exception cref="Cilnn.NanomsgException">Thrown if a socket can't be created for this domain and protocol</exception>
        ...
        /// <exception cref="Cilnn.NanomsgException">Thrown if the address is invalid</exception>
        ...
        /// <exception cref="Cilnn.NanomsgException">Thrown if the socket is in an invalid state or the endpoint's shutdown attempt was interrupted and should be reattempted.</exception>
        ...
        /// </summary>
        /// <exception cref="Cilnn.NanomsgException">Thrown if the socket is invalid or the close attempt was interrupted and should be reattempted.</exception>
        public void Dispose()
        {
            Dispose(true);
        ...
        /// <exception cref="Cilnn.NanomsgException">Thrown if the socket is in an invalid state, the send was interrupted, or the send timeout has expired</exception>
        ...
        /// <exception cref="Cilnn.NanomsgException">Thrown if the socket is in an invalid state, the receive was interrupted, or the receive timeout has expired</exception>
